package org.rapipdm.iot.vaadin.tinkerforge.v002;
...
public class LCD20x4 {
    ...
    public LCD20x4(final String UID, IPConnection ipConnection) {
        lcd = new BrickletLCD20x4(UID, ipConnection);
    }
    ...
    public void init(){
        try {
            lcd.backlightOn();
            lcd.clearDisplay();
            lcd.setDefaultText((short) 0, utf16ToKS0066U("will prepare now.."));
